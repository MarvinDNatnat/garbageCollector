...
<body data-bs-spy="scroll" data-bs-target="#bsb-tpl-navbar" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <nav id="scrollspyNav" class="navbar navbar-expand-lg bsb-tpl-bg-blue bsb-navbar bsb-navbar-hover bsb-navbar-caret bsb-tpl-navbar-sticky" data-bsb-sticky-target="#header">
      <div class="container d-flex align-items-center justify-content-between">
          ...
          <a class="navbar-brand" href="index.html">
              <img src="./assets/img/branding/wave-logo.png" class="bsb-tpl-logo" alt="Logo">
          </a>
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
              ...
              <div class="offcanvas-body">
                  <ul id="bsb-tpl-navbar" class="navbar-nav d-flex align-items-center ms-auto">
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="#scrollspyAbout" data-bs-dismiss="offcanvas" data-bs-target="#offcanvasNavbar">About Us</a>
                      </li>
                      <li class="nav-item">
                          <a class="btn btn-primary px-3 py-2 rounded ms-lg-3" 
                             href="#" 
                             data-bs-target="#" 
                             aria-controls="#" 
                             role="button">
  ...
  <section id="scrollspyHero" class="bsb-hero-2 bsb-tpl-bg-blue py-5 py-xl-8 py-xxl-10">
    <div class="container overflow-hidden">
      <div class="row gy-1 gy-lg-0 align-items-lg-center justify-content-lg-between">
        <div class="col-12 col-lg-6 order-1 order-lg-0">
          <h6 class="display-1 fw-bolder mb-1">Smart Waste Management for startups at affordable rates. Schedule, Track and Pay with Ease!</h6>
        </div>
        <div class="col-12 col-lg-5 text-center">
          <img class="img-fluid" loading="lazy" src="./assets/img/branding/wave-logo.png" alt="" style="-webkit-mask-image: url(./assets/img/hero/hero-blob-1.svg); mask-image: url(./assets/img/hero/hero-blob-1.svg);">
        </div>
      </div>
    </div>
  </section>
  ...
  <main id="main">
    ...
    <section id="scrollspyPortfolio" class="py-5 py-xl-8 bsb-section-py-xxl-1">
      <div class="container mb-5 mb-md-6 mb-xl-10">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h6 class="display-3 fw-bolder mb-4">Welcome to your Dashboard</h6>
          </div>
        </div>
      </div>

      <div class="container overflow-hidden">
        <div class="row gy-2 g-md-2 g-xl-3 bsb-project-2-grid " style="gap: 32px">
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <div class="card" style="width: auto;">
              <div class="card-body">
                <h5 class="card-title">Total Pickups scheduled</h5>
                <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div>
            </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <div class="card" style="width: auto;">
              <div class="card-body">
                <h5 class="card-title">Upcoming Pickup</h5>
                <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div>
            </div>
          ...
          <div class="col-12 col-md-12 bsb-project-2-item">
            <div class="card" style="width: auto;" >
              <div class="card-body">
          ...
          <div class="col-12 col-sm-6 col-xl-4">
            <div class="card border-0 border-bottom border-primary shadow-sm">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <p class="fs-5 mb-0 text-secondary">User Dashboard</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-xl-4">
            <div class="card border-0 border-bottom border-primary shadow-sm">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <p class="fs-5 mb-0 text-secondary">Schedule</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-xl-4">
            <div class="card border-0 border-bottom border-primary shadow-sm">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <p class="fs-5 mb-0 text-secondary">Tracking</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-xl-4">
            <div class="card border-0 border-bottom border-primary shadow-sm">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <p class="fs-5 mb-0 text-secondary">Payment</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-xl-4">
            <div class="card border-0 border-bottom border-primary shadow-sm">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <p class="fs-5 mb-0 text-secondary">Data Analytics</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-xl-4">
            <div class="card border-0 border-bottom border-primary shadow-sm">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <p class="fs-5 mb-0 text-secondary">Settings and Profile</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container overflow-hidden">
        <div class="row gy-4 gy-lg-0 justify-content-xl-between">
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
            <div class="widget">
              <a href="#!">
                <img src="./assets/img/branding/wave-logo.png" alt="" class="bsb-tpl-logo-footer">
              </a>
            </div>
          </div>
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
